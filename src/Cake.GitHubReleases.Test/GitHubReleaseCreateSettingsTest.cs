...
namespace Cake.GitHubReleases.Test
{
    ...
    /// </summary>
    public class GitHubReleaseCreateSettingsTest
    {
        [Theory]
        ...
        public void Constructor_parameter_must_not_be_null_or_whitespace(string owner, string repository, string tagName)
        {
            ...
            // ACT
            var ex = Record.Exception(() => new GitHubReleaseCreateSettings(repositoryOwner: owner, repositoryName: repository, tagName: tagName));
        ...
        {
            // ARRANGE
            var sut = new GitHubReleaseCreateSettings("owner", "repo", "tagName");
